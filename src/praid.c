...
int main(int argc,char **argv)
{
	...
	LOG_ENABLED= atoi(CONFIG_getValue(praid_config,"Log"));//TRUE = 1;FALSE = 0;
	if(LOG_ENABLED){
	...
	sleep(1);
	socketInet_t listen_toPPD = SOCKET_inet_create(SOCK_STREAM,"192.168.1.107",9035,MODE_LISTEN);
